...
#   * Finally, don't worry about the indent, CocoaPods strips it!
  ...
  s.source_files = 'MicoupImagePicker/Classes/**/*.{h,m}'
  
  s.resource_bundles = {
    'Resources' => [
      'MicoupImagePicker/Assets/*.{storyboard}',
      'MicoupImagePicker/Assets/*.{xcassets}'
    ]
  }
  
  s.public_header_files = [
    'MicoupImagePicker/Classes/MCPMicoupImagePicker.h',
    'MicoupImagePicker/Classes/ViewController/*.{h}',
    'MicoupImagePicker/Classes/Model/*.{h}'
  ]
