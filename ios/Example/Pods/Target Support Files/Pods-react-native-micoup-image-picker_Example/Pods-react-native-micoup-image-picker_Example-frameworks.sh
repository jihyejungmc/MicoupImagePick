...
if [[ "$CONFIGURATION" == "Debug" ]]; then
  ...
  install_framework "${BUILT_PRODUCTS_DIR}/MCPMicoupImagePicker/MCPMicoupImagePicker.framework"
  ...
  install_framework "${BUILT_PRODUCTS_DIR}/POSInputStreamLibrary/POSInputStreamLibrary.framework"
  ...
  install_framework "${BUILT_PRODUCTS_DIR}/UIButton+BackgroundColor/UIButton_BackgroundColor.framework"
