...
import com.missycoupons.fishbun.ui.picker.PickerController;
import com.missycoupons.fishbun.util.SquareTextView;
            ...
            vh.imgThumbImage.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    if (vh.txtThumbCount.getVisibility() == View.GONE &&
                        ...
                        pickerController.setBottombarText(pickedImages.size());
